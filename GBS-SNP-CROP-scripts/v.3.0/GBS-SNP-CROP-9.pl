...
##################################################################################################################
# GBS-SNP-CROP, Step 9. For description, see Melo et al. (2016) BMC Bioinformatics DOI 10.1186/s12859-016-0879-y.
##################################################################################################################
...
my $Usage = "Usage: perl GBS-SNP-CROP-9.pl -in <SNP genotyping matrix> -out <output string> -ref <Mock reference Clusters>";
