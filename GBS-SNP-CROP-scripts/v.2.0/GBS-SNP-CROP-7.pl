...
##########################################################################################################################
# GBS-SNP-CROP, Step 7. For description, see User Manual (https://github.com/halelab/GBS-SNP-CROP/wiki)
##########################################################################################################################
...
while (<$VAR>) {
	...
	# Applying genotype representation filter
	...
	# Applying genotype proportion filter
...
print "\nYour $output genotyping matrix was successfully created and can be found in the SNPsCalled directory. \n";
