...
# 
# For help: perl GBS-SNP-CROP-8.pl help
###########################################################################################################
#########################################################
...
my $H = "\n###########################################################\n"
	...
	."-formats: The desired formats (R, Tassel, Plink, vcf, H) into which the GBS-SNP-CROP final genotyping matrix should be converted. If more than one format is desired, the names should be separated by commas without any space. String. Default: R,P,T,V,H\n\n";
