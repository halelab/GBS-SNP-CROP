...
##########################################################################################################################
# GBS-SNP-CROP, Step 4. For description, please see Melo et al. (2016) BMC Bioinformatics 17:29. DOI 10.1186/s12859-016-0879-y.
##########################################################################################################################
...
# Step 4A: Sorting the FASTQ sequences in order of decreasing length (bp)
...
# Step 4B: Finding initial clusters (centroids)
...
# Step 4C: Sorting genotype-specific initial clusters (centroids) by depth 
...
# Step 4D: Reclustering the genotype-specific centroids
